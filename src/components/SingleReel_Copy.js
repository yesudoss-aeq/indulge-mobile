...
const SingleReel = ({ item, index, visibleIndex, currentIndex, currentTag, setCurrentTag, videoViewStyle }) => {
    console.log("currentIndex::", item, "item.index::", item.index, "index::", index)
        ...
        >
            ...
            >
                <Video
                    ...
                    minLoadRetryCount={5}
                    paused={visibleIndex === item.index ? paused : true}
                    ...
                    source={{ uri: "https://d37tcz5mzsenlm.cloudfront.net/assets/0665d0c3-7d1f-40b7-93cb-fb92b135949e/MP4/PORSCHE.mp4" }}
                    style={{
            ...
            {/* <Text style={[styles.pauseORResumeview, { marginBottom: 100 }]}>Visible {isVisible, paused}</Text> */}
            {isBuffering &&
